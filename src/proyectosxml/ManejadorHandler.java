...
public class ManejadorHandler extends DefaultHandler {
	...
	/*
	 * Para poder progamar lo que hacen los métodos, antes voy a ver cuáles son los
	 * datos que tiene mi archivo versiones.xml. Para ello usaré un ArrayList donde
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		super.startElement(uri, localName, qName, attributes); // To change body of generated methods, choose Tools |
																// Templates.
		...
		case "version":
			...
			/*
			 * El parámetro attributes recibe el atributo del elemento Con el metodo
			 * getValues, cojo el valor del atributo. Pero se devuelve un double del xml,
			 * asique hay que parsearlo
			 */
			version.setNumero(Double.parseDouble(attributes.getValue("numero")));
			break;
		case "nombre":
			/*
			 * Ahora vacío el buffer desde el inicio hasta el final para que a la próxima
			 * lectura de texto, no haya conflictos
			 */
